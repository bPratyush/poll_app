...
func (nu *NotificationUpdate) SetPollID(i int) *NotificationUpdate {
	nu.mutation.ResetPollID()
	nu.mutation.SetPollID(i)
	return nu
}

// SetNillablePollID sets the "poll_id" field if the given value is not nil.
func (nu *NotificationUpdate) SetNillablePollID(i *int) *NotificationUpdate {
	if i != nil {
		nu.SetPollID(*i)
	}
	return nu
...
func (nu *NotificationUpdate) AddPollID(i int) *NotificationUpdate {
	nu.mutation.AddPollID(i)
	return nu
}

// ClearPollID clears the value of the "poll_id" field.
func (nu *NotificationUpdate) ClearPollID() *NotificationUpdate {
	nu.mutation.ClearPollID()
	return nu
}
...
func (nu *NotificationUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := nu.mutation.PollID(); ok {
		_spec.SetField(notification.FieldPollID, field.TypeInt, value)
	}
	if value, ok := nu.mutation.AddedPollID(); ok {
		_spec.AddField(notification.FieldPollID, field.TypeInt, value)
	}
	if nu.mutation.PollIDCleared() {
		_spec.ClearField(notification.FieldPollID, field.TypeInt)
	}
...
// SetPollID sets the "poll_id" field.
func (nuo *NotificationUpdateOne) SetPollID(i int) *NotificationUpdateOne {
	nuo.mutation.ResetPollID()
	nuo.mutation.SetPollID(i)
	return nuo
}

// SetNillablePollID sets the "poll_id" field if the given value is not nil.
func (nuo *NotificationUpdateOne) SetNillablePollID(i *int) *NotificationUpdateOne {
	if i != nil {
		nuo.SetPollID(*i)
	}
	return nuo
...
// AddPollID adds i to the "poll_id" field.
func (nuo *NotificationUpdateOne) AddPollID(i int) *NotificationUpdateOne {
	nuo.mutation.AddPollID(i)
	return nuo
}

// ClearPollID clears the value of the "poll_id" field.
func (nuo *NotificationUpdateOne) ClearPollID() *NotificationUpdateOne {
	nuo.mutation.ClearPollID()
	return nuo
}
...
func (nuo *NotificationUpdateOne) sqlSave(ctx context.Context) (_node *Notification, err error) {
	...
	if value, ok := nuo.mutation.PollID(); ok {
		_spec.SetField(notification.FieldPollID, field.TypeInt, value)
	}
	if value, ok := nuo.mutation.AddedPollID(); ok {
		_spec.AddField(notification.FieldPollID, field.TypeInt, value)
	}
	if nuo.mutation.PollIDCleared() {
		_spec.ClearField(notification.FieldPollID, field.TypeInt)
	}
